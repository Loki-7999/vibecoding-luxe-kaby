...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 antialiased text-nordic-dark dark:text-gray-100 relative overflow-hidden">
      ...
      <main className="w-full max-w-md z-10">
        ...
        <div className="bg-surface dark:bg-[#152e2a] rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 dark:border-primary/20 backdrop-blur-sm">
          ...
          {error ? (
            <p className="mt-5 text-sm text-red-600 dark:text-red-400 text-center">{error}</p>
          ) : null}
